...
public class HotelGateway {
    ...
    private class ClientHandler extends Thread {
        ...
        private void handleRequest(BufferedReader request,
            ...
            if (procedure == null) {
                sendResponse(response, STATUS_PROTOCOL_ERROR,
                             "Malformed request: no procedure");
                return;
            }
            ...
            if (parameter == null) {
                sendResponse(response, STATUS_PROTOCOL_ERROR,
                             "Malformed request: premature end of request");
                return;
            }
            ...
            if (procedure.equals("book")) {
                if (parameters.size() < 1) {
                    sendResponse(response, STATUS_PROTOCOL_ERROR,
                                 "Malformed request: not enough parameters");
                    return;
                }
                ...
                sendResponse(response, STATUS_PROTOCOL_ERROR,
                             "Malformed request: unknown procedure");
                return;
            }
        ...
        private void handleBookRequest(DataOutputStream response,
                                       int type,
                                       String guest) throws IOException {
            ...
            try {
                ...
                sendResponse(response, STATUS_APPLICATION_ERROR,
                             "Error contacting hotel service: "
        ...
        private void handleListRequest(DataOutputStream response)
            throws IOException {
        ...
        private void handleGuestsRequest(DataOutputStream response)
            throws IOException {
            ...
            if (registeredGuests == null || registeredGuests.isEmpty()) {
                ...
                SortedSet<String> sorted_registeredGuests =
                    new TreeSet<String>(registeredGuests);
                List<String> responseList = new ArrayList<String>();
        ...
        private void sendResponse(DataOutputStream response,
                                  int status,
                                  String description,
        ...
        private void sendResponse(DataOutputStream response,
            ...
            sendResponse(response, status, description,
