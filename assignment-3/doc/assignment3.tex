...
interface. % TODO: hold this promise
...
a problem. % TODO: adapt this to new synchronization strategy
...
documentation for the hotel gateway in section \ref{sec:gateway}.) % TODO float description

\paragraph{Question 6}
% TODO: we need to give a list of files for each program. maybe
% consider both runtime and compiletime dependencies...
